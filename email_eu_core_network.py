...
evaluation.evaluate_cpm(email_eu_graph_processed, louvain_final_partition, gamma=0.1, method="Louvain")
evaluation.evaluate_cpm(email_eu_graph_processed, leiden_final_partition, gamma=0.1, method="Leiden")
