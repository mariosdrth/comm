...
evaluation.evaluate_cpm(brain_graph_processed, louvain_final_partition, gamma=0.2, method="Louvain")
evaluation.evaluate_cpm(brain_graph_processed, leiden_final_partition, gamma=0.2, method="Leiden")
